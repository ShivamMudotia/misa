         ...
         stage('Build and Push Docker Image') {
               steps{
                     script {
                            ...
                            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: '', reportFiles: 'zap-full-scan-report.html', reportName: 'Zap_Report', reportTitles: 'MISA', useWrapperFileDirectly: true])
