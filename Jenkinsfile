         ...
         stage('Build and Push Docker Image') {
               steps{
                     script {
                            ...
                            sh "sleep 30"
                            sh "docker run --rm -it -v $(pwd):/zap/wrk/:rw --network=localhost owasp/zap2docker-stable zap-full-scan.py -t http://${env.service_name}:3000 -r zap-full-scan-report.html"
