         ...
         stage('Build and Push Docker Image') {
               steps{
                     script {
                            ...
                            sh "sleep 30"
                            sh "docker run --rm -t -v $(pwd):/zap/wrk/:rw --network=localhost owasp/zap2docker-stable zap-full-scan.py -r zap-full-scan-report.html -t http://${env.service_name}:3000"
